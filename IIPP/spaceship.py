...
class Ship:
    ...
    def update(self):
        ...
        self.vel[0] = (self.vel[0] + self.ship_acc[0]
                       * ship_vector[0]) * FRICTION
        self.vel[1] = (self.vel[1] + self.ship_acc[1]
                       * ship_vector[1]) * FRICTION
    ...
    def shoot(self):
        ...
        missile = Sprite(pos, vel, 0, 0, missile_image,
...
def rock_spawner():
    ...
    speed = [(random.random() * 6 - 3) * coeff,
             (random.random() * 6 - 3) * coeff]
...
def group_collide(group, other_object):
    ...
    for obj in set(group):
        if obj.collide(other_object):
            res = True
            group.remove(obj)
            explosion = Sprite(other_object.get_pos(), [
                               0, 0], 0, 0, explosion_image, explosion_info)
